...
#define DP8_BMCR_REG        0x0	/*y!< Basic Mode Control Register */
#define DP8_BMSR_REG        0x1	/*x!< Basic Mode Status Reg */
#define DP8_ANADV_REG       0x4	/*x!< Auto_Neg Advt Reg  */
#define DP8_ANLPA_REG       0x5	/*x!< Auto_neg Link Partner Ability Reg */
#define DP8_ANEEXP_REG      0x6	/*x!< Auto-neg Expansion Reg  */
#define DP8_PHY_STAT_REG    0x10/*y!< PHY Status Register  */
#define DP8_PHY_INT_CTL_REG 0x11/*n!< PHY Interrupt Control Register */
#define DP8_PHY_RBR_REG     0x17/*y!< PHY RMII and Bypass Register  */
#define DP8_PHY_STS_REG     0x19/*n!< PHY Status Register  */
...
#define DP8_PHYID1_OUI     0x0243		/*!< Expected PHY ID1 */
#define DP8_PHYID2_OUI     0x05c0		/*!< Expected PHY ID2 */
