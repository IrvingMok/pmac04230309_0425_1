...
const static char http_index_html[] = "<html><head><title>Congrats!</title></head><body><h1>欢迎来到智能终端管理服务控制台!</h1><p>This is a small test page, served by httpserver-netconn.</body></html>";
...
http_server_netconn_thread(void *arg)
{
  ...
  err_t err;
	unsigned int http_idx=0;
  LWIP_UNUSED_ARG(arg);
	while (1) {
		printf("http_server_netconn_thread starting\r\n");
		while(!ip_rdy)
		{
